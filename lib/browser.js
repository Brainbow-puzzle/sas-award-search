...
async function capture({ startUrl, storageStatePath, outDir }) {
  ...
  console.log(
    ...
    "prices per date to anonymous visitors.\n\n" +
    "  1. Open the low-price calendar (\"Lavpriskalender\" on the Danish site).\n" +
    "  2. Tick \"Betal med point\" / \"Pay with points\" so the grid shows points.\n" +
    "  3. Pick your route and page to the month you want.\n" +
    "  4. Wait until the points appear on the date cells.\n\n" +
    "That calendar returns a whole month per request, which is what makes a bulk\n" +
    "pull cheap. A single-date search works too, but costs ~30x the requests.\n",
  );
